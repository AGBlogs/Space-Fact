...
import TimePhoto from './TimeTravel.jpg'
...
function Blog2() {
    return (
        <div className="blog">
            ...
            <Para title="NAme of the structure" content="The lrgest known structure in the Universe is a 18 billion light-years across." imageSrc={StructuredPhoto} clas={'Structure'} />
